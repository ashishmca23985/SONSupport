...
export class DepartmentComponent implements OnInit{
  ...
  constructor(private DepartmentService:MasterPagesService, private toastr: ToastrService){}
  ngOnInit()
  {
    this.getDepartment();
  }
  ...
  editRow(dept_id:number)
  {
    ...
    this.DepartmentService.editDepartment(dept_id).subscribe();
  }

  deleteRow(dept_id:number)
  {
    this.DepartmentService.deleteDepartment(dept_id).subscribe(
      res=>
        {
          this.getDepartment();
        });
  ...
  onSubmit() {
    this.DepartmentService.addDepartment().subscribe(
      res=>
        {
          this.getDepartment();
        });
